...
public class ungoy_ni_karl_final {
    ...
    static String[] playerPairedCards = new String[26];
    static String[] botPairedCards = new String[26];
    ...
    public static void play(){
        ...
        System.out.println("\nONE RANDOM CARD HAS BEEN REMOVE {ANO SYA? SECRET}\n");
    ...
    public static void findPairs(String[] hand){
        ...
        for (int i = 0; i < hand.length; i++) {
            ...
            if (currentCard != null && !contains(currentCard, playerPairedCards)) {
                for (int j = i + 1; j < hand.length; j++) {
                    ...
                    if (hand[j] != null && currentCard.split(":")[1].equals(hand[j].split(":")[1])) {
                        ...
                        playerPairedCards = add(currentCard, playerPairedCards);
                        playerPairedCards = add(hand[j], playerPairedCards);
    ...
    public static void playerPick(){   
        ...
        if (game!=false) {
            System.out.println("===========================================");
            System.out.println("\t  the bot has "+botHand.length+" cards"+"\n\t   you have "+playerHand.length+" cards\n\t<--- pick from 1-"+botHand.length+" --->");
            System.out.println("===========================================");
            System.out.print("\n[note that the deck shown is shuffled when picking, bawal ka mag daya!]\npick one to steal: ");
            int steal = sc.nextInt();

            botHand = shuffle(botHand);
            ...
            while(steal <1 || steal > botHand.length) {
                System.out.print("That is not an option, try again: ");
                steal = sc.nextInt();
            }
            //display the stolen card
            System.out.println("\n===================================================================");
            System.out.println("\n{{{===| you stole the "+ botHand[steal-1] +" from the opponent's hand |===}}}" );
            System.out.println("\n===================================================================\n");
            ...
            if (proceed == 1) {
                ...
                playerHand = add(botHand[steal-1], playerHand);

                // removes it from the opponent
                botHand = remove(botHand[steal-1], botHand);
    ...
    public static void botPick(){
        ...
        if (game != false) {
            ...
            int botpick = ran.nextInt(playerHand.length)+1;

            // displays stolen card
            System.out.println("\n===================================================================");
            System.out.println("\n{{{===| the bot stole the "+ playerHand[botpick-1]+" from your hand |===}}}" );
            System.out.println("\n===================================================================\n");
            ...
            if (proceed ==1) {
                // adds the stolen card to the hand
                botHand = add(playerHand[botpick-1], botHand);

                // removes it from the player
                playerHand = remove(playerHand[botpick-1], playerHand);
    ...
    public static boolean contains(String card, String[] pairs){
    ...
    public static String[] add(String currentcard, String[] hand){
        String[] newHand = new String[hand.length+1];

        int count = 0;
        while (count < newHand.length) {
            if(count == newHand.length-1){
                newHand[count]=currentcard;
                count++;
            }else{
                newHand[count] = hand[count];
                count++;
            }
        }
        return newHand;
    ...
    public static String[] remove(String card, String[] hand){
        String[] newHand;
        for (int i = 0; i < hand.length; i++) {
            if (hand[i] == card) {
                hand[i] = null;
    ...
    public static int length(String[] hand){
        int count = 0;
        for (int i = 0; i < hand.length; i++) {
            if (hand[i] != null) {
                count++;
    ...
    public static String[] update(String[] hand){
        int count = 0;
        for (int i = 0; i < hand.length; i++) {
            if (hand[i]!=null) {
                count++;
        ...
        String[] updatedHand = new String[count];

        int count2 = 0;
        for (int i = 0; i < hand.length; i++) {
            if (hand[i]!=null) {
                updatedHand[count2]=hand[i];
                count2++;
            }
        }
        return updatedHand;
